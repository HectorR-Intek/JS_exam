"use strict";
function Person(first, last){                           //Constructor function for Person object.
    this.firstName = first;
    this.lastName = last;
}

Person.prototype.greet = function(){                    // We add a method called greet.
...
Medic.prototype.sendRequest = function(){
    const url = `https://api.doctors.com/info?${this.generateQuery()}`;
